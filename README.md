...
- [openclaw/openclaw](https://github.com/openclaw/openclaw) ([v2026.6.2-beta.1](https://github.com/openclaw/openclaw/releases/tag/v2026.6.2-beta.1), 2 days ago) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 
- [paperclipai/paperclip](https://github.com/paperclipai/paperclip) ([v2026.529.0](https://github.com/paperclipai/paperclip/releases/tag/v2026.529.0), 6 days ago) - The open-source app everyone uses to manage agents at work
...
- [feat(openrouter): add inbound audio STT support](https://github.com/openclaw/openclaw/pull/77463) on [openclaw/openclaw](https://github.com/openclaw/openclaw) (1 month ago)
